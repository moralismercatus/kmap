 ...
 ******************************************************************************/
#pragma once
#ifndef KMAP_PATH_NODE_VIEW2_LEFT_LINEAL_HPP
#define KMAP_PATH_NODE_VIEW2_LEFT_LINEAL_HPP
...
class LeftLineal : public DerivationLink
{
...
auto const left_lineal = LeftLineal{};

} // namespace kmap::view2

#endif // KMAP_PATH_NODE_VIEW2_LEFT_LINEAL_HPP
